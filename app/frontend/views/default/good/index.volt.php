                ...
                <div class="order-state-panel">
                    <div class="panel-header">
                        <div class="ng-binding">
                            ...
                            <img class="img_circle_right " style="-webkit-animation: run 60s linear; " src="<?= $this->url->getStatic('/index/picture/right_circle1.png') ?> "></div>
                            <div class="left_circle ">
                            <img class="img_circle_lift " style="-webkit-animation: runaway 60s linear; " src="<?= $this->url->getStatic('/index/picture/left_circle1.png') ?> "></div>
                            </div>
...
<div class="modal-backdrop hide">
    ...
    <script src="<?= $this->url->getStatic('/index/js/echarts.js') ?>"></script>
    <script src="<?= $this->url->getStatic('/index/js/m.js') ?>"></script>
